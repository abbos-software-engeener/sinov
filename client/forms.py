...
class RegistrationForm(forms.ModelForm):
    confirm = forms.CharField(max_length=50, widget=forms.PasswordInput, label=_("Parolni takroran"))
    ...
    class Meta:
        ...
        help_texts = {
            "username": _("Lotin harflari, sonlar va @/./+/-/_ belgilardan iborat bo'lish lozim.")
        }
        widgets = {
